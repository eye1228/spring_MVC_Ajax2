...
$(function() {
	...
	$("#btn2").click(function() {
		//serialize() : form안에 있는 모든 파라미터값이 직렬로 전달 된다.
		$.ajax({
			url : "insert.do",
			method: "post",
...
<body>
	...
	<form method="post" id="myForm">
		<table>
			<thead>
				<tr>
					<tr><th>ID</th><th>PW</th><th>NAME</th><th>AGE</th><th>ADDR</th>
				</tr>
			</thead>
			<tbody>
				<tr>
	...
	<div>
		<table>
			<thead>
				...
				<th>AGE</th><th>ADDR</th><th>REG</th><th>삭제</th></tr>
			</thead>
